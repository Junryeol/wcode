import { viewCode, cleanCode, getCode } from './editor';
 ...
 * @return {void}
 */
export const setFileTreeHandler = (ref) => {
    fileTreeHandler = ref
};
